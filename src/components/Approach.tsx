...
const Approach = () => {
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-row items-center justify-center w-full gap-4 sm:flex-col xs:flex-col">
        {/* add des prop */}
        <Card
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      ...
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px] text-white">
        <span
          className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite]
         bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] text-white"
        />
        <span
