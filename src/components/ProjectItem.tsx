    ...
    return (
        <>
            <CardContainer className="inter-var shadow-2xl !py-2" containerClassName='!py-2'>
                <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-light/75 dark:bg-black/75 dark:border-white/55 border-black/[0.1] w-auto sm:w-auto h-auto rounded-xl p-6 border h-[477px]">
                    <CardItem
                        translateZ="50"
